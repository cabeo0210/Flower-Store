...
public class LoginServlet extends HttpServlet {
    ...
    private final String ACTION_PAGE = "LoadPageSearchServlet";
    ...
    protected void processRequest(HttpServletRequest request, HttpServletResponse response)
        ...
        try {
            ...
            if (dto != null) {                
                ...
                session.setAttribute("USERNAME", dto.getName().trim());
                session.setAttribute("USER_LOGIN", dto);
                boolean isAdmin = dto.isIsAdmin();
                if (isAdmin) {                    
                    url = ACTION_PAGE;
                } else {
                    url = ACTION_PAGE;
